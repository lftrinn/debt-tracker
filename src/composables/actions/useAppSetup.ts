...
/**
 * Composable quản lý vòng đời khởi tạo ứng dụng.
 * Schema v2: AppData dùng transactions[], debts[] flat array, schema_version: 2.
 */
export function useAppSetup(
  ...
  async function pullData(): Promise<void> {
    try {
      ...
      api.syncTime.value = ''
      appState.value = Array.isArray(d.value.debts) ? 'error' : 'setup'
    }
  }
